...
uses
  ...
  ComCtrls, qrexport, QRPrntr, QuickRpt, QR4Const, QRCtrls, grimgctrl, pdfconst, LZW;
...
begin
  ...
  try
    if (GControl is TQRHRule) then begin
      ...
      PDFItem.thickness:=HCont.Pen.Width;
    ...
    if (GControl is TQRPDFShape) then begin
      ...
      PDFItem.XPos:=Xoff*PointsPerPixelX;
      PDFItem.YPos:=Yoff*PointsPerPixelY;
      PDFItem.thickness:=PShCont.Pen.Width;
    ...
    if (GControl is TQRShape) then begin
      ...
      PDFItem.XPos:=Xoff*PointsPerPixelX;
      PDFItem.YPos:=Yoff*PointsPerPixelY;
      PDFItem.thickness:=ShCont.Pen.Width;
    ...
    PDFItem.yscale:=1.0;
    PDFItem.ImageData:='';
    if (GControl is TQRGrImage) then begin
