{ :::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
  ...
  :: 25/05/2006 fixed fmtBCD and ftTimestamp                 ::
  ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: }
...
uses
  Windows, Sysutils, Classes, DB, Forms, DBTables, QR4Const;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if (FField is TDateField) or (FField.DataType = ftTimestamp) then
          begin
            result.Kind := resString;
...
begin
  ...
  begin
    ...
    if assigned(objects[i]) then objects[i].Free; // saves memory leak
