...
uses
  ...
  Dialogs, Ex_Grid, ExtCtrls, Menus, ImgList;
...
const
  SAbout =
    'WMF file information viewer'#13 +
    'Copyright © 1999 Roman M. Mochalov'#13 +
    ''#13 +
    'E-mail: roman@sar.nnov.ru';
  Flags = MB_OK or MB_ICONINFORMATION;
begin
  MessageBox(Handle, PChar(SAbout), PChar(Application.Title), Flags);
end;
