...
type
  TForm1 = class(TForm)
    ...
    procedure GridView1EditCloseUp(Sender: TObject; Cell: TGridCell; ItemIndex: Integer; var Accept: Boolean);
    procedure GridView1EditSelectNext(Sender: TObject; Cell: TGridCell; var Value: string);
...
begin
  Accept := (Cell.Col in [2..4, 6..8]) and (Cell.Row in [1..4, 6..8, 10..19]);
end;
...
procedure TForm1.GridView1EditCloseUp(Sender: TObject; Cell: TGridCell; ItemIndex: Integer; var Accept: Boolean);
begin
  ShowMessage('Close Up...');
end;

procedure TForm1.GridView1EditSelectNext(Sender: TObject; Cell: TGridCell; var Value: string);
begin
